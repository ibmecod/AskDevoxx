...
var ConversationPanel = (function () {
    ...
    function displayMessage(newPayload, typeValue) {
        ...
        if (isUser) {
            // User entered text
            textExists = newPayload.text;
        } else {
            // Watson returned text
            textExists = newPayload.responseText || newPayload.output.text;
        }
    ...
    function buildMessageDomElement(newPayload, isUser) {
        ...
        if (isUser) {
            outputText = newPayload.text;
        } else {
            outputText = newPayload.responseText;
            if (outputText == null) {
                outputText = newPayload.output.text;
            } else if (outputText.toLowerCase().includes("corpus")) {
                outputText = newPayload.resources[0].body;
            }
        }
